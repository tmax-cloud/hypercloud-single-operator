...
# destination file
output="/var/lib/jenkins/workspace/hypercloud-single-operator/CHANGELOG.md"
timestamp=`date`
version=$1
prev_version=$2
...
backup="/var/lib/jenkins/workspace/hypercloud-single-operator/CHANGELOG_$prev_version.md"
if [ -f $output ]; then
